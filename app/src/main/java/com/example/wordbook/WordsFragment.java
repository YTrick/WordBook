    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.tuichu:
                ...
                new androidx.appcompat.app.AlertDialog.Builder(getContext()).setTitle("系统提示")//设置对话框标题
                        ...
                        .setPositiveButton("确定",new DialogInterface.OnClickListener() {//添加确定按钮
                            ...
                            public void onClick(DialogInterface dialog, int which) {//确定按钮的响应事件
                                SharedPreferences sp = getActivity().getSharedPreferences("userInfo", getContext().MODE_PRIVATE);
                                SharedPreferences.Editor editor_tuichu = sp.edit();
                                String username = sp.getString("username","");
                                String password = sp.getString("password","");
                                boolean checkboxBoolean = sp.getBoolean("checkboxBoolean",false);

                                editor_tuichu.putString("username", "");
                                editor_tuichu.putString("password", "");
                                editor_tuichu.putBoolean("checkboxBoolean",false);
                                editor_tuichu.commit();
